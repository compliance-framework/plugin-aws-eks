...
func TestBuildSubjectTemplatesIncludesEksResourceFamilies(t *testing.T) {
...
func TestSubjectTemplateTitleAndDescriptionRenderWithUnderscoreLabels(t *testing.T) {
	labels := map[string]string{
		...
		"region":         "eu-west-2",
		"cluster_name":   "prod",
		"cluster_arn":    "arn:aws:eks:eu-west-2:123456789012:cluster/prod",
		"nodegroup_name": "workers",
		"nodegroup_arn":  "arn:aws:eks:eu-west-2:123456789012:nodegroup/prod/workers/id",
		"addon_name":     "vpc-cni",
		"addon_arn":      "arn:aws:eks:eu-west-2:123456789012:addon/prod/vpc-cni/id",
	}
